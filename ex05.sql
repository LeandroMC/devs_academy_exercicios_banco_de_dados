...
-- 16)
INSERT INTO emprestimo (id_aluno, id_livro, data_emprestimo) VALUES (100, 1000, '2010-08-13');
INSERT INTO emprestimo (id_aluno, id_livro, data_emprestimo) VALUES (100, 1080, '2010-08-14');
INSERT INTO emprestimo (id_aluno, id_livro, data_emprestimo) VALUES (200, 1110, '2010-08-15');
INSERT INTO emprestimo (id_aluno, id_livro, data_emprestimo) VALUES (300, 1150, '2010-08-15');
INSERT INTO emprestimo (id_aluno, id_livro, data_emprestimo) VALUES (500, 1120, '2010-08-16');
INSERT INTO emprestimo (id_aluno, id_livro, data_emprestimo) VALUES (500, 1130, '2010-08-16');
INSERT INTO emprestimo (id_aluno, id_livro, data_emprestimo) VALUES (600, 1010, '2010-08-16');
INSERT INTO emprestimo (id_aluno, id_livro, data_emprestimo) VALUES (700, 1020, '2010-08-16');
INSERT INTO emprestimo (id_aluno, id_livro, data_emprestimo) VALUES (800, 1040, '2010-08-15');
/******************** * CONSULTAS ********************/ 
-- Mostrando todos os livros que possuem categoria 
-- Cláusula ON SELECT l.id_livro, l.titulo, c.id_categoria, c.categoria FROM livro l INNER JOIN categoria c ON l.id_categoria = c.id_categoria; 
-- Mostrando todos os livros que possuem categoria 
-- Cláusula USING 
-- A cláusula USING pode ser usada quando a chave primária é 
-- igual a chave estrangeira SELECT l.id_livro, l.titulo, c.id_categoria, c.categoria FROM livro l INNER JOIN categoria c USING (id_categoria);


-- Mostrando os livros que possuem e que não possuem categoria
SELECT l.id_livro, l.titulo, c.id_categoria, c.categoria
FROM livro l LEFT OUTER JOIN categoria c
USING (id_categoria);
...
SELECT a.id_aluno, a.nome, e.data_emprestimo, e.data_devolucao
FROM aluno a
...
SELECT a.id_aluno, a.nome, l.id_livro, l.titulo, e.data_emprestimo, e.data_devolucao
FROM aluno a 
INNER JOIN emprestimo e 
ON a.id_aluno = e.id_aluno 
...
-- Mostrando todos os livros que os alunos pegaram emprestados. 
-- Mostrar também as categorias de cada
SELECT a.id_aluno, a.nome, l.id_livro, l.titulo, c.id_categoria, c.categoria, e.data_emprestimo, e.data_devolucao
FROM aluno a
INNER JOIN emprestimo e
ON a.id_aluno = e.id_aluno
INNER JOIN livro l
